...
sudo apt install -y git unzip bc libncurses5-dev mercurial lib32stdc++6 libc6-i386 lib32z1 u-boot-tools android-tools-fastboot build-essential libusb-1.0-0-dev curl android-tools-fsutils pkg-config libacl1-dev zlib1g-dev liblzo2-dev uuid-dev git fastboot u-boot-tools adb u-boot-tools android-tools-fastboot u-boot-tools curl wget sunxi-tools sudo apt-get install swig python-dev cmake python-is-python3 python3-pippip3 install pyyaml build-essential git debootstrap u-boot-tools device-tree-compiler g++-aarch64-linux-gnu g++-arm-linux-gnueabihf gcc-arm-linux-gnueabihf android-tools-fastboot sunxi-tools u-boot-tools git fakeroot build-essential ncurses-dev xz-utils libssl-dev bc flex libelf-dev bison git fakeroot build-essential ncurses-dev xz-utils libssl-dev bc flex libelf-dev bison crossbuild-essential-armhf crossbuild-essential-arm64 libssl-dev make libc6-dev libncurses5-dev libssl-dev make virt-manager qemu-user-static curl gcc git libssl-dev libncurses5-dev lzop make u-boot-tools gcc-arm-linux-gnueabi git-core gnupg build-essential zip curl zlib1g-dev gcc-multilib g++-multilib libc6-dev-i386 lib32ncurses5-dev x11proto-core-dev libx11-dev lib32z1-dev libgl1-mesa-dev libxml2-utils xsltproc unzip fontconfig net-tools intel-microcode firmware-realtek firmware-misc-nonfree putty screen sed make binutils build-essential gcc g++ bash patch gzip bzip2 perl tar cpio unzip rsync file bc wget python3 cvs git mercurial rsync subversion asciidoc w3m dblatex graphviz which sed make binutils build-essentials gcc g++ bash patch gzip bzip2 perl tar cpio unzip rsync file bc wget gparted libusb-1.0-0-dev zlib1g-dev hackrf hacktv build-essential ccache curl flex g++-multilib gcc-multilib git gnupg gperf imagemagick lib32ncurses5-dev lib32readline-dev lib32z1-dev liblz4-tool libncurses5 libncurses5-dev libsdl1.2-dev libssl-dev libxml2 libxml2-utils lzop pngcrush rsync schedtool squashfs-tools xsltproc zip zlib1g-dev gnome-flashback gnome-flashback-common gnome-session-flashback gnome-panel gnome-panel-data synaptic android-sdk-libsparse-utils git-core gitk git-gui gcc-arm-linux-gnueabihf u-boot-tools device-tree-compiler gcc-aarch64-linux-gnu mtools parted libudev-dev libusb-1.0-0-dev gcc-arm-linux-gnueabihf libssl-dev gcc-aarch64-linux-gnu g+conf autotools-dev libsigsegv2 m4 intltool libdrm-dev curl sed make binutils build-essential gcc g++ bash patch gzip bzip2 perl tar cpio python2.7 unzip rsync file bc wget libncurses5 libglib2.0-dev libgtk2.0-dev libglade2-dev cvs git mercurial rsync openssh-client subversion asciidoc w3m dblatex graphviz libc6 libssl-dev texinfo liblz4-tool genext2fs lib32stdc++6 coreboot-utils libflashrom-dev libflashrom1 mkelfimage xgridfit vflib3-dev vflib3 unifont fonts-unifont x11-xfs-utils debos bmap-tools
#sudo apt -y install apt-utils software-properties-common gnupg lsb-release python-all python-all-dev python-all-dbg python3-all apache2 python3-all-dbg python3-all-dev lvm2 thin-provisioning-tools ssh python3-pkg-resources python3-virtualenv python3-oauth2client build-essential zip curl zlib1g-dev libc6-dev libncurses5 x11proto-core-dev libx11-dev libxml2-utils xsltproc unzip fontconfig libncurses-dev gawk openssl libssl-dev dkms libelf-dev libudev-dev libpci-dev libiberty-dev autoconf sed make cmake binutils gcc-11 gcc-11-arm-linux-gnueabihf g++-11 g++-11-arm-linux-gnueabihf patch gzip bzip2 perl tar cpio unzip rsync file bc wget qt3d5-dev qt3d5-dev-tools gtk2-engines glade cvs git subversion rsync asciidoc w3m graphviz flex bison swig bmap-tools f2fs-tools qemu-system-x86 qemu-user-static binfmt-support squashfs-tools-ng apt-transport-https ca-certificates curl gnupg-agent software-properties-common dialog libgtk2.0-dev qemu-system libvirt-daemon-system libvirt-clients bridge-utils virtinst virt-manager uuid uuidcdef gitk git-gui curl xz-utils nano screen fakeroot uuid-runtime uuid-dev hackrf libhackrf-dev dfu-util hacktv default-jdk python-is-python3 libgl1-mesa-dev libglib2.0-dev libglade2-dev intel-microcode firmware-realtek firmware-misc-nonfree putty 
...
sed -i -e '$aexport PATH=~/work/arm-gnu-toolchain-12.2.mpacbti-bet1-x86_64-arm-none-eabi:$PATH' ~/.bashrc #add sed command to check if this is already there
